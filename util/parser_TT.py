...
parser.add_argument("--gpu", default=False, type=str2bool,
                    help='whether to use GPU for training and inference')
...
parser.add_argument("--auxi_lambda", default=0.2, type=float,  # from sensitivity analysis, we can set it to 0.2
...
parser.add_argument("--data_source", default="MSDS", type=str,
                    help='the data source: MSDS or RE2_OB')
