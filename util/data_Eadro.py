...
def run(evaluation_epoch=10):
    data_dir = os.path.join("/home/db2003/Desktop/Amr/Tests/Eadro/codes/chunks", params["data"])
    ...
    train_data = chunkDataset(train_chunks, node_num, edges,params["chunk_lenth"])
    test_data = chunkDataset(test_chunks, node_num, edges, params["chunk_lenth"])
    
    shapes = {
        "metric_dim": metric_num,
        "trace_dim": 2,
        "window_size": params["chunk_lenth"],
        "node_num": node_num,
        "event_num": event_num
    }
